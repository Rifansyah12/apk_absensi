...
exports.DivisionSettingController = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
class DivisionSettingController {
    async getAllDivisionSettings(req, res) {
        try {
    ...
    async getDivisionSetting(req, res) {
        try {
            if (!req.user || req.user.role !== 'SUPER_ADMIN') {
                res.status(403).json({
                    success: false,
    ...
    async updateDivisionSetting(req, res) {
        try {
            if (!req.user || req.user.role !== 'SUPER_ADMIN') {
                res.status(403).json({
                    success: false,
    ...
    async createDivisionSetting(req, res) {
        try {
            if (!req.user || req.user.role !== 'SUPER_ADMIN') {
                res.status(403).json({
                    success: false,
...
exports.DivisionSettingController = DivisionSettingController;
//# sourceMappingURL=division-setting-controller.js.map